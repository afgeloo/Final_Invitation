...
class Gameplay2iiAA extends StatefulWidget {
  const Gameplay2iiAA({super.key});

  @override
  _Gameplay2iiAAState createState() => _Gameplay2iiAAState();
}

class _Gameplay2iiAAState extends State<Gameplay2iiAA> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/gameplay2iiAA.png'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
                    ...
                    children: [
                      DefaultTextStyle(
                        ...
                        child: _isTextComplete
                            ? Text(
                                'The book reveals that disturbing the casket will bring misfortune and lists rituals to appease spirits. The pages turn on their own, showing you a picture of a young child who looks just like you.',
                      ...
                      if (_isTextComplete) ...[
                        ...
                        GestureDetector(
                          ...
                          child: SizedBox(
                            ...
                            child: Image.asset(
                              'assets/images/button_A_gameplay2iiAA.png',
                              fit: BoxFit.contain,
                            ),
                          ),
                        ),
                        ...
                        GestureDetector(
                          ...
                          child: SizedBox(
                            ...
                            height: 50, // Adjust the height as needed
                            child: Image.asset(
                              'assets/images/button_B_gameplay2iiAA.png',
                              fit: BoxFit.contain,
                            ),
                          ),
                        ),
